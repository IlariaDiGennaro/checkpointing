...
//#pragma once /*I:include il codice che segue una sola volta,indipendentemente da quante volte è importato*/
...
/*ILARIA*/
//#define IOCTL_GET_INFO_SIBLING_PGD _IOW(KTBLMGR_IOCTL_MAGIC, 23 , int )
//#define IOCTL_DUMMY_READ _IOW(KTBLMGR_IOCTL_MAGIC, 24 , int )
#define IOCTL_AUDIT_TRACKING_STRUCTURE _IO(KTBLMGR_IOCTL_MAGIC, 23)
#define IOCTL_DEBUG_WORST_CASE _IO(KTBLMGR_IOCTL_MAGIC, 26)
#define IOCTL_ITERATE_PAGE _IO(KTBLMGR_IOCTL_MAGIC, 25)
#define IOCTL_CLEAN_ACCESSES _IO(KTBLMGR_IOCTL_MAGIC, 27)
/**/
...
#define PML4(addr) (((long long)(addr) >> 39) & 0x1ff) /* F=1111 */
#define PDP(addr)  (((long long)(addr) >> 30) & 0x1ff)
#define PDE(addr)  (((long long)(addr) >> 21) & 0x1ff)
#define PTE(addr)  (((long long)(addr) >> 12) & 0x1ff)

#define OBJECT_TO_PML4(object_id) ((ulong)object_id >> 9 ) /*I:?*/
#define OBJECT_TO_PDP(object_id) ((ulong)object_id &  0x1ff) /*I:?*/

#define GET_ADDRESS(addr)  ( (((long long)(addr)) & ((1LL << 40) - 1)) >> 12) /*I:indirizzo di PML4+PDP?*/
